...
export default function BeyondOptimization() {
  return (
    <ScrollThemeSection className="container space-y-18">
      <div className="space-y-6">
        <h2>
          Beyond <span className="text-highlight">Search Optimization</span>
        </h2>
        <p className="lg:w-1/2">
          We build complete demand generation systems. Explore how we create
          content, design websites, marketing strategy implementation and
          execute paid campaigns that convert discovery into revenue.
        </p>
      </div>
