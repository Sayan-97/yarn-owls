    ...
    <div className="container grid lg:grid-cols-2 gap-8 items-start">
      <div className="space-y-6 lg:sticky lg:top-20">
        <h2>
          ...
          <span className="text-highlight">Neither Should Your Marketing.</span>
        </h2>
        <p>
          Modern research happens everywhere: search engines, AI tools, social
          feeds, peer networks. Real growth comes from meeting buyers across all
          these moments, not betting on one channel. We unify SEO, AI
